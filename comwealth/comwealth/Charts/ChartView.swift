...
enum ChartData {
    static let last30Days: [Series] = [
        .init(name: "Cupertino", points: [
            .init(date: date(year: 2022, month: 3, day: 2), value: 42),
            .init(date: date(year: 2022, month: 3, day: 3), value: 88),
            .init(date: date(year: 2022, month: 3, day: 4), value: 49),
            .init(date: date(year: 2022, month: 3, day: 5), value: 42),
            .init(date: date(year: 2022, month: 3, day: 6), value: 61),
            .init(date: date(year: 2022, month: 3, day: 7), value: 67),
            .init(date: date(year: 2022, month: 3, day: 8), value: 54),
            .init(date: date(year: 2022, month: 3, day: 9), value: 47),
            .init(date: date(year: 2022, month: 3, day: 10), value: 42),
            .init(date: date(year: 2022, month: 3, day: 11), value: 71),
            .init(date: date(year: 2022, month: 3, day: 12), value: 56),
            .init(date: date(year: 2022, month: 3, day: 13), value: 81),
            .init(date: date(year: 2022, month: 3, day: 14), value: 40),
            .init(date: date(year: 2022, month: 3, day: 15), value: 49),
            .init(date: date(year: 2022, month: 3, day: 16), value: 42),
            .init(date: date(year: 2022, month: 3, day: 17), value: 58),
            .init(date: date(year: 2022, month: 3, day: 18), value: 66),
            .init(date: date(year: 2022, month: 3, day: 19), value: 62),
            .init(date: date(year: 2022, month: 3, day: 20), value: 77),
            .init(date: date(year: 2022, month: 3, day: 21), value: 55),
            .init(date: date(year: 2022, month: 3, day: 22), value: 52),
            .init(date: date(year: 2022, month: 3, day: 23), value: 42),
            .init(date: date(year: 2022, month: 3, day: 24), value: 49),
            .init(date: date(year: 2022, month: 3, day: 25), value: 58),
            .init(date: date(year: 2022, month: 3, day: 26), value: 61),
            .init(date: date(year: 2022, month: 3, day: 27), value: 68),
            .init(date: date(year: 2022, month: 3, day: 28), value: 43),
            .init(date: date(year: 2022, month: 3, day: 29), value: 49),
            .init(date: date(year: 2022, month: 3, day: 30), value: 67),
            .init(date: date(year: 2022, month: 3, day: 31), value: 125)
        ]),
